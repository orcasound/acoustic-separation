...
resume_checkpoint = "zeroshot/checkpoints/zeroshot_asp_full.ckpt"
...
# for evaluation
test_key = ["orca"] # four tracks for musdb, and your named track for other inference
test_type = "mix"
infer_type = "mean"
energy_thres = 0.1
...
# for inference
inference_query = "zeroshot/query" # a folder containing all samples for obtaining the query